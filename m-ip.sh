...
echo -e "         $COLOR1         ${WH}Telegram: t.me/HendraStore    ${NC}"
echo -e "         $COLOR1      ${WH}Whatsapp: wa.me//+6282184684197    ${NC}"
echo -e "         $COLOR1╰══════════════════════════════════════════╯${NC}"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/HendraVPN/Register/main/"
